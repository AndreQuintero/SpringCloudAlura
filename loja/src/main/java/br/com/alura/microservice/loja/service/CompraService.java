...
public class CompraService {
	...
	public Compra realizaCompra(CompraDTO compra) {
		/*
     * CRIADO APENAS POR CURIOSIDADE PARA VER COMO É UMA REQUISIÇÃO REST TEMPLATE
     * ResponseEntity<InfoFornecedorDTO> exchange =
     * client.exchange("http://fornecedor/info/"+
     * compraDTO.getEndereco().getEstado(), HttpMethod.GET, null,
     * InfoFornecedorDTO.class); // o null envia informações
     * 
     * /* curiosidade para saber todas as instancias de fornecedor
     */
    /*
